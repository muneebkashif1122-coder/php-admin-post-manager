            ...
            <div class="form-panel" style="max-width: 600px; margin: 0 auto;">
                ...
                <form id="edit-author-form" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="author" class="form-control" value="<?php echo htmlspecialchars($current_author['author']); ?>" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label font-weight-bold">Biography (Bio)</label>
                        <textarea name="bio" class="form-control" rows="4"><?php echo htmlspecialchars($current_author['bio'] ?? ''); ?></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <?php if (!empty($current_author['image'])): ?>
                            <div class="mt-2">
                                ...
                                <img src="../../<?php echo htmlspecialchars($current_author['image']); ?>" style="max-height: 100px; object-fit: contain;" class="rounded border p-1 mt-1">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            ...
            if (responseMsg) {
                responseMsg.innerHTML = '<div class="alert alert-info">Processing author updates...</div>';
            }
            ...
            .then(function(data) {
                ...
                if (data.status === 'success') {
                    ...
                    setTimeout(function() { window.location.href = 'list.php'; }, 1200);
                } else {
            ...
            .catch(function(error) {
                ...
                responseMsg.innerHTML = '<div class="alert alert-danger">Server communication failure. Check backend configuration.</div>';
            });
        });
    }
});
