            ...
            <div class="form-panel" style="max-width: 600px; margin: 0 auto;">
                ...
                <form id="edit-category-form">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control" value="<?php echo htmlspecialchars($current_category['name']); ?>" required>
                    </div>
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            ...
            .catch(function(error) {
                ...
                responseMsg.innerHTML = '<div class="alert alert-danger">Server connection error or invalid backend configuration.</div>';
            });
        });
    }
});
