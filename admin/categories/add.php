    ...
    <div class="flex-grow-1 p-5">
        ...
        <form id="category-form">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="category_name" class="form-control" placeholder="e.g. Technology, Health" required>
            </div>
    ...
    $('#category-form').submit(function (e) {
        ...
        $.ajax({
            ...
            error: function (xhr, status, error) {
                ...
                $('#response-msg').html('<div class="alert alert-danger">' + error + '</div>');
            }
        });
    });
});
